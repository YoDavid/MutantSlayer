...
public class MainMenuButtonsFade : MonoBehaviour
{
    public static MainMenuButtonsFade instance;
    public MainMenuColorChange[] mainMenuSlots;
    ...
    IEnumerator FadeSlot(MainMenuColorChange slot, bool fadeIn)
    {
